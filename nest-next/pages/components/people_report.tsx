      ...
      <div className="box box-info">
        ...
        <div className="box-body">
          <p>
            ...
            <br />{i18n.t('people.report.famselfreg', 'List families that were created via self registration.')}
          </p>
          <p>
            <a className="MediumText" href="GroupReports">{i18n.t('Reports on groups and roles')}</a>
            <br />{i18n.t('people.report.groupAndroles', 'Report on group and roles selected (it may be a multi-page PDF).')}
          </p>
          <p><a className="MediumText" href="DirectoryReports">{i18n.t('People Directory')}</a>
            <br />{i18n.t('people.report.PrintDirectory', 'Printable directory of all people, grouped by family where assigned')}
          </p>
          <p>
            <a className="MediumText" href="LettersAndLabels">{i18n.t('Letters and Mailing Labels')}</a>
            <br />{i18n.t('people.report.Generatelabels', 'Generate letters and mailing labels.')}
          </p>
          <p>
            <a className="MediumText" href="USISTAddressVerification">{i18n.t('US Address Verification Report')}</a>
            <br />{i18n.t('people.report.USAddress', 'Generate report comparing all US family addresses with United States Postal Service Standard Address Format.')}
          </p>
        </div>
      </div>
    );
